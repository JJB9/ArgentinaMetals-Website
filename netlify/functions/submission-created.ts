...
function renderContactEmail(input: ContactFields): { html: string; text: string; subject: string } {
  ...
  const messageDisplay = esc(input.message);
...
<html lang="en" style="color-scheme:light dark;supported-color-schemes:light dark;">
  <head>
    ...
    <style>
      ...
      @media (prefers-color-scheme: dark) {
        ...
        .em-divider { border-top-color:#2a2824 !important; }
  ...
  <body class="em-bg" style="margin:0;padding:0;background-color:#f0ede5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#1a1917;">
    <div style="display:none;font-size:1px;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;mso-hide:all;color:#f0ede5;">${esc(preheader)}&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;</div>
          ...
          <tr><td class="em-pad" style="padding:40px 40px 8px;">
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 24px;">
              <tr>
                ...
                <td class="em-row-value em-value" style="padding:0 0 12px 0;font-size:15px;color:#1a1917;vertical-align:top;mso-line-height-rule:exactly;">${nameDisplay}<br><a href="mailto:${emailDisplay}" class="em-link" style="color:#c5642b;text-decoration:underline;">${emailDisplay}</a></td>
              </tr>
              <tr>
                ...
                <td class="em-row-value em-value" style="padding:0 0 12px 0;font-size:15px;color:#1a1917;vertical-align:top;mso-line-height-rule:exactly;">${topicDisplay}</td>
              </tr>
            </table>
            ...
            <div class="em-message-box em-body" style="margin:0 0 32px;padding:16px 20px;background-color:#fdfcf9;border:1px solid #e8e5dd;border-radius:10px;font-size:15px;line-height:1.6;color:#1a1917;white-space:pre-wrap;mso-line-height-rule:exactly;">${messageDisplay}</div>

            <p class="em-faint" style="margin:0;font-size:12px;line-height:1.6;color:#9a9588;mso-line-height-rule:exactly;">Reply to this email to respond directly to the sender — Reply-To is set to their address.</p>
          </td></tr>
